function finalweighteddata = weightsofsandwichingvalidvalsposs6point1(inputtimes,inputdata,curdescleantime,i,j,missingdataval)
%From an index of interest in an time-denominated inputvec, looks for valid values both before and after
%   Built for 'possibility 6.1' in testvaluesatstandardtimes
%   If no valid value can be found on either of the sides, both weights are set to a missing value

%For testing:
%inputtimes=[7;18];
%inputdata=[-1;5];
%descleantimes=[11]; %on the first of the 3 days spanned
...
if greenlightnumber1==1 && greenlightnumber2==1
    distlatertime=distlatertime+48;
