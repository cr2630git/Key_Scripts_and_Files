function valuesatcleantimes = valuesatstandardtimesfromnonstandard2(descleantimes,inputtimes,inputday,inputdata,missingdataval)
...
troubleshoot=0; %whether to display troubleshooting messages
%numbers with absolute values greater than or equal to missingdataval are assumed to be missing or invalid
...
for i=1:size(descleantimes,1)
    ...
    if troubleshoot==1;fprintf('Curdescleantime is %0.2f, corresponding to an i of %d\n',curdescleantime,i);end
    somethingfound=0;
    j=2;
    ...
    while j<=size(inputtimes,1) && somethingfound==0
            ...
            if thishoursearching>=curdescleantime && prevhoursearching<curdescleantime && dayofthishour==dayofprevhour
                ...
                finalweighteddata=weightsofsandwichingvalidvalsposs1(inputtimes,inputdata,curdescleantime,i,j,missingdataval);
                if troubleshoot==1
                    fprintf('i and j are %d and %d\n',i,j);
            ...
            if thishoursearching>=curdescleantime && prevhoursearching>curdescleantime && dayofthishour==dayofprevhour+1
                ...
                finalweighteddata=weightsofsandwichingvalidvalsposs2(inputtimes,inputdata,curdescleantime,i,j,missingdataval);
                if troubleshoot==1
                    fprintf('i and j are %d and %d\n',i,j);
            ...
            if thishoursearching<=curdescleantime && prevhoursearching<curdescleantime && dayofthishour==dayofprevhour+1
                ...
                finalweighteddata=weightsofsandwichingvalidvalsposs3(inputtimes,inputdata,curdescleantime,i,j,missingdataval);
                if troubleshoot==1
                    fprintf('i and j are %d and %d\n',i,j);
            ...
            if thishoursearching>=curdescleantime && prevhoursearching<curdescleantime && dayofthishour==dayofprevhour+1
                ...
                finalweighteddata=weightsofsandwichingvalidvalsposs4point1(inputtimes,inputdata,curdescleantime,i,j,missingdataval);
                if troubleshoot==1
                    fprintf('i and j are %d and %d\n',i,j);
            ...
            if thishoursearching>=curdescleantime && prevhoursearching<curdescleantime && dayofthishour==dayofprevhour+1
                ...
                finalweighteddata=weightsofsandwichingvalidvalsposs4point2(inputtimes,inputdata,curdescleantime,i,j,missingdataval);
                if troubleshoot==1
                    fprintf('i and j are %d and %d\n',i,j);
            ...
            if thishoursearching<=curdescleantime && prevhoursearching<curdescleantime && dayofthishour==dayofprevhour+2
                ...
                finalweighteddata=weightsofsandwichingvalidvalsposs5point1(inputtimes,inputdata,curdescleantime,i,j,missingdataval);
                if troubleshoot==1
                    fprintf('i and j are %d and %d\n',i,j);
            ...
            if thishoursearching<=curdescleantime && prevhoursearching<curdescleantime && dayofthishour==dayofprevhour+2
                ...
                finalweighteddata=weightsofsandwichingvalidvalsposs5point2(inputtimes,inputdata,curdescleantime,i,j,missingdataval);
                if troubleshoot==1
                    fprintf('i and j are %d and %d\n',i,j);
            ...
            if thishoursearching<=curdescleantime && prevhoursearching<curdescleantime && dayofthishour==dayofprevhour+2
                ...
                finalweighteddata=weightsofsandwichingvalidvalsposs5point3(inputtimes,inputdata,curdescleantime,i,j,missingdataval);
                if troubleshoot==1
                    fprintf('i and j are %d and %d\n',i,j);
            ...
            if thishoursearching>=curdescleantime && prevhoursearching<curdescleantime && dayofthishour==dayofprevhour+2
                ...
                finalweighteddata=weightsofsandwichingvalidvalsposs6point1(inputtimes,inputdata,curdescleantime,i,j,missingdataval);
                if troubleshoot==1
                    fprintf('i and j are %d and %d\n',i,j);
            ...
            if thishoursearching>=curdescleantime && prevhoursearching<curdescleantime && dayofthishour==dayofprevhour+2
                ...
                finalweighteddata=weightsofsandwichingvalidvalsposs6point2(inputtimes,inputdata,curdescleantime,i,j,missingdataval);
                if troubleshoot==1
                    fprintf('i and j are %d and %d\n',i,j);
            ...
            if thishoursearching>=curdescleantime && prevhoursearching<curdescleantime && dayofthishour==dayofprevhour+2
                ...
                finalweighteddata=weightsofsandwichingvalidvalsposs6point3(inputtimes,inputdata,curdescleantime,i,j,missingdataval);
                if troubleshoot==1
                    fprintf('i and j are %d and %d\n',i,j);
    ...
    exist finalweighteddata;
    if ans==0;finalweighteddata=missingdataval;end
    
    
    valuesatcleantimes(i)=finalweighteddata;
end
