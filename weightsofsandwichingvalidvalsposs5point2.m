function finalweighteddata = weightsofsandwichingvalidvalsposs5point2(inputtimes,inputdata,curdescleantime,i,j,missingdataval)
%From an index of interest in an time-denominated inputvec, looks for valid values both before and after
%   Built for 'possibility 5.2' in testvaluesatstandardtimes
%   If no valid value can be found on either of the sides, both weights are set to a missing value

%For testing:
%inputtimes=[22;1];
%inputdata=[14;8];
%descleantimes=[5]; %on the second of the 3 days spanned
%i=1 -- the index of descleantimes
%therefore curdescleantime=5;
