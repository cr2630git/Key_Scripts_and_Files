function finalweighteddata = weightsofsandwichingvalidvalsposs4point1(inputtimes,inputdata,curdescleantime,i,j,missingdataval)
%From an index of interest in an time-denominated inputvec, looks for valid values both before and after
%   Built for 'possibility 4.1' in testvaluesatstandardtimes
...
if greenlightnumber1==1 && greenlightnumber2==1
    distlatertime=distlatertime+24; %adjust distances for the circumstances of this case
