function COUNT = countnumberofoccurrences(A,B)
%   COUNT = COUNTNUMBEROFOCCURRENCES(A,B) counts the number of times the elements of array A are
...
%
%   Examples:
%     countnumberofoccurrences([1 2 1 3],[1 2 2 2 2])
%       %  -> 1     4     1     0
%     countnumberofoccurrences(3214,[1 3214 98 -1 7 10 2 3 3214 97 10 11])
%          -> 2
%
%   See also ISMEMBER, UNIQUE, HISTC

% tested in R2015a
% version 2.0 (apr 2016) -- original name: countmember
% (c) Jos van der Geest
