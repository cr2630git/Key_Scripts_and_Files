...
% 1000 mb; 850 mb; 700 mb; 500 mb; 300 mb; 200 mb
%THE NUMERICAL INDICES FOR THE PRESSURE LEVELS VARY BY FILE TYPE -- 
%ALWAYS VERIFY TO BE SURE
%if using omega: 1000 mb, 950 mb, 900 mb, 850 mb, 700 mb, 500 mb
...
%Then call: narrNcToMat(rawNcDir,outputDir,'air',1000,'8xdaily')

%Current runtime: about 30 sec per monthly file


function narrNcToMat(rawNcDir, outputDir, varName, maxNum, timeStep)
%pressureLevels=[1 3 5 7 13 17]; %typical levels for omega
pressureLevels=[0 6 12 16 20 24]; %typical levels otherwise
