...
%
%   DESCRIPTION:
%     MATLAB works with a unique COLORMAP by each figure, which is a big
...
%       as normally colorbars when resizing the peer axes. Although, sometimes the normal behavior
%       is not that good.
...
%       this function. Anyway, 'off' or 'del' may help.
