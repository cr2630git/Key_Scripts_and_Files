function finalweighteddata = weightsofsandwichingvalidvalsposs4point2(inputtimes,inputdata,curdescleantime,i,j,missingdataval)
%From an index of interest in an time-denominated inputvec, looks for valid values both before and after
%   Built for 'possibility 4.2' in testvaluesatstandardtimes
